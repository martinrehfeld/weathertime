...
#          esp. check FR/NL translation of PLUGIN_SCREENSAVER_WEATHERTIME_START
...
sub screensaverWeatherTimelines {
	...
	$timeinfo = Slim::Utils::Misc::timeF().Dateformatted();
